...
public static class EnumsHelper
{
    ...
    /// <returns></returns>
    public static int CodigoEnum(this Enum enumValue)
    {
    ...
    /// <returns></returns>
    public static E EnumPorCodigo<E>(int enumCodigo)
    {
    ...
    /// <returns></returns>
    public static string DescricaoEnum(this Enum enumValue)
    {
        var result = "";
        var memInfo = enumValue.GetType().GetMember(enumValue.ToString());
        if (memInfo == null || memInfo.Length == 0) return result;
    ...
    /// <returns></returns>
    public static string DescricaoEnumPorCodigo<E>(int enumCodigo)
    {
        return (EnumPorCodigo<E>(enumCodigo) as Enum).DescricaoEnum();
    }
